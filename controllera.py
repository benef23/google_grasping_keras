...
@nrp.MapRobotPublisher("joint1", Topic("/robota/arm_1_joint/cmd_pos", std_msgs.msg.Float64)) 
@nrp.MapRobotPublisher("rewarda_ros", Topic("/rewarda", std_msgs.msg.Float64))
@nrp.MapRobotSubscriber("links", Topic("/gazebo/link_states", gazebo_msgs.msg.LinkStates)) 
@nrp.MapRobotPublisher("joint4", Topic("/robota/arm_4_joint/cmd_pos", std_msgs.msg.Float64))
@nrp.MapRobotPublisher("joint2", Topic("/robota/arm_2_joint/cmd_pos", std_msgs.msg.Float64))
@nrp.MapRobotPublisher("joint5", Topic("/robota/arm_5_joint/cmd_pos", std_msgs.msg.Float64))
@nrp.MapRobotPublisher("joint3", Topic("/robota/arm_3_joint/cmd_pos", std_msgs.msg.Float64))
@nrp.MapRobotSubscriber("joints", Topic("/jointState", sensor_msgs.msg.JointState))
@nrp.MapVariable("agent", initial_value=None)
@nrp.MapVariable("session1", initial_value=None)
@nrp.MapVariable("graph1", initial_value=None)
#actuators


@nrp.Neuron2Robot()
def controllera (t, joints, links, joint2, joint3, joint4, joint5, rewarda_ros, joint1, agent, graph1, session1):
